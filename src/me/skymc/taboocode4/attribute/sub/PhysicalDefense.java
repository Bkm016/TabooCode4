...
public class PhysicalDefense implements SpecialAttribute {
	...
	public boolean register(FileConfiguration conf, boolean first) {
		file = conf;
		if (first) {
			conf.set("Settings.Primary", "Spell Defense: [$][?][$]");
			conf.set("Settings.Regular", "[$]\\* Spell Defense");
			conf.set("Settings.Percent", "[$]\\% Spell Defense");
