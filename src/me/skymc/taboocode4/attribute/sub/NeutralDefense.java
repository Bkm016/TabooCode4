...
public class NeutralDefense implements SpecialAttribute {
	...
	public boolean register(FileConfiguration conf, boolean first) {
		file = conf;
		if (first) {
			conf.set("Settings.Primary", "Neutral Defense: [$][?][$]");
			conf.set("Settings.Regular", "[$]\\* Neutral Defense");
			conf.set("Settings.Percent", "[$]\\% Neutral Defense");
