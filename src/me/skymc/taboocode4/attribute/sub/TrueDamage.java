...
public class TrueDamage implements SpecialAttribute {
	...
	public boolean register(FileConfiguration conf, boolean first) {
		file = conf;
		if (first) {
			conf.set("Settings.Primary", "True Damage: [$][?][$]");
			conf.set("Settings.Regular", "[$]\\* True Damage");
			conf.set("Settings.Percent", "[$]\\% True Damage");
