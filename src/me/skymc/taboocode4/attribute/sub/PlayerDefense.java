...
public class PlayerDefense implements SpecialAttribute {
	...
	public boolean register(FileConfiguration conf, boolean first) {
		file = conf;
		if (first) {
			conf.set("Settings.Primary", "Player Defense: [$][?][$]");
			conf.set("Settings.Regular", "[$]\\* Player Defense");
			conf.set("Settings.Percent", "[$]\\% Player Defense");
