...
public class ProjectileDefense implements SpecialAttribute {
	...
	public boolean register(FileConfiguration conf, boolean first) {
		file = conf;
		if (first) {
			conf.set("Settings.Primary", "Projectile Defense: [$][?][$]");
			conf.set("Settings.Regular", "[$]\\* Projectile Defense");
			conf.set("Settings.Percent", "[$]\\% Projectile Defense");
