...
public class SpellsDefense implements SpecialAttribute {
	...
	public boolean register(FileConfiguration conf, boolean first) {
		file = conf;
		if (first) {
			conf.set("Settings.Primary", "Magic Defense: [$][?][$]");
			conf.set("Settings.Regular", "[$]\\* Magic Defense");
			conf.set("Settings.Percent", "[$]\\% Magic Defense");
