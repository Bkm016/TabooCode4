...
public class MonsterDamage implements SpecialAttribute {
	...
	public boolean register(FileConfiguration conf, boolean first) {
		file = conf;
		if (first) {
			conf.set("Settings.Primary", "Monster Damage: [$][?][$]");
			conf.set("Settings.Regular", "[$]\\* Monster Damage");
			conf.set("Settings.Percent", "[$]\\% Monster Damage");
