...
public class AddMana implements SubCommandExecutor {
	...
	public boolean command(CommandSender sender, String[] args) {
		...
		double mana = ManaManager.getPlayerMana(player);
		...
		if (mana + manaregen > manamax) {
			...
			ManaManager.getPlayerData().put(player.getName(), mana + manaregen);
